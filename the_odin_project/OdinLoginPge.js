...
})(
    {
        ...
        2: [
            function (n, e, t) {
                function r(n, e, t, r, i) {
                    l[n] || (l[n] = {});
                    var a = l[n][e];
                    return a || ((a = l[n][e] = { params: t || {} }), i && (a.custom = i)), (a.metrics = o(r, a.metrics)), a;
                }
                function o(n, e) {
                    return (
                        e || (e = { count: 0 }),
                ...
                function i(n, e) {
                    return e ? (e && !e.c && (e = { t: e.t, min: e.t, max: e.t, sos: e.t * e.t, c: 1 }), (e.c += 1), (e.t += n), (e.sos += n * n), n > e.max && (e.max = n), n < e.min && (e.min = n), e) : { t: n };
                }
                function a(n, e) {
                ...
                var f = n(36),
                    l = {};
                e.exports = { store: r, take: u, get: a };
            },
            {},
        ],
        3: [
            function (n, e, t) {
                ...
                function i(n, e) {
                    if (e && "object" == typeof e && e.name && e.start) {
                        var t = { n: e.name, s: e.start - v.offset, e: (e.end || e.start) - v.offset, o: e.origin || "", t: "api" };
                        h("bstApi", [t]);
                    }
                }
                ...
                f.on("jserrors", function () {
                    return { body: l.take(["cm"]) };
                });
                var y = { finished: d(o), setPageViewName: r, setErrorHandler: u, addToTrace: i, inlineHit: a, addRelease: s };
                m(y, function (n, e) {
                    c("api-" + n, e, "api");
                });
                var b = 0;
        ...
        4: [
            function (n, e, t) {
                ...
                var s = n(36),
                    ...
                    l = 64;
                e.exports = { nullable: r, numeric: o, getAddStringContext: i, addCustomAttributes: a };
                var d = /([,\\;])/g;
            },
            {},
        ],
        ...
        7: [
            function (n, e, t) {
                ...
                e.exports = { obj: a, fromArray: i, qs: o, param: u };
            },
            {},
        ],
        8: [
        ...
        9: [
            function (n, e, t) {
                function r(n) {
                    if (n.info.beacon) {
                        n.info.queueTime && x.store("measures", "qt", { value: n.info.queueTime }),
                            n.info.applicationTime && x.store("measures", "ap", { value: n.info.applicationTime }),
                            k.measure("be", "starttime", "firstbyte"),
                            k.measure("fe", "firstbyte", "onload"),
                            k.measure("dc", "firstbyte", "domContent");
                        ...
                        if (t) {
                            ...
                            if (
                                (o.push(t),
                                o.push(g.param("tt", n.info.ttGuid)),
                                o.push(g.param("us", n.info.user)),
                                o.push(g.param("ac", n.info.account)),
                                o.push(g.param("pr", n.info.product)),
                                o.push(
                                    g.param(
                                        "af",
                                        v(n.features, function (n) {
                                            return n;
                                        }).join(",")
                                    )
                                ),
                                ...
                                var i = { timing: h.addPT(window.performance.timing, {}), navigation: h.addPN(window.performance.navigation, {}) };
                            ...
                            if (window.performance && window.performance.getEntriesByType) {
                                ...
                                a.forEach(function (n) {
                                    !n.startTime ||
                                        n.startTime <= 0 ||
                                        ("first-paint" === n.name ? o.push(g.param("fp", String(Math.floor(n.startTime)))) : "first-contentful-paint" === n.name && o.push(g.param("fcp", String(Math.floor(n.startTime)))),
                                        M(n.name, Math.floor(n.startTime)));
                                });
                            }
                            ...
                            b.jsonp("https://" + n.info.beacon + "/" + r + "/" + n.info.licenseKey + s, A);
                        }
                    }
                }
                function o(n) {
                    var e = v(N, function (e) {
                        return u(e, n, { unload: !0 });
                    });
                    return w(e, i);
                }
                function i(n, e) {
                ...
                function a(n) {
                    for (var e = p({}), t = p({}), r = N[n] || [], o = 0; o < r.length; o++) {
                        var i = r[o]();
                ...
                function s(n, e, t, r) {
                    ...
                    switch (n) {
                        case "jserrors":
                            (a = !1), (i = _ ? b.beacon : b.img);
                            break;
                        default:
                            if (r.needResponse) (a = !0), (i = b.xhr);
                            else if (r.unload) (a = _), (i = _ ? b.beacon : b.img);
                            else if (R) (a = !0), (i = b.xhr);
                            else {
                ...
                function d(n) {
                    var e = !0;
                    return (
                        "init" in NREUM && "privacy" in NREUM.init && (e = NREUM.init.privacy.cookies_enabled),
                        [
                            "?a=" + n.info.applicationID,
                            g.param("sa", n.info.sa ? "" + n.info.sa : ""),
                            g.param("v", T),
                            f(n),
                            g.param("ct", n.customTransaction),
                            "&rst=" + n.now(),
                            "&ck=" + (e ? "1" : "0"),
                            g.param("ref", S(E.getLocation())),
                        ].join("")
                    );
                }
                function p(n) {
                ...
                var m = n(19),
                    ...
                    A = "NREUM.setToken",
                    N = {},
                    _ = !!navigator.sendBeacon;
                n(10);
                var R = j.ieVersion > 9 || 0 === j.ieVersion,
                    M = n(16).addMetric;
                e.exports = { sendRUM: m(r), sendFinal: o, pingErrors: c, sendX: u, send: s, on: l, xhrUsable: R };
            },
            {},
        ],
        10: [
            ...
            function (n, e, t) {
                function r(n, e) {
                    ...
                    return (
                        ...
                        i(n[f + u], t, e, "dne"),
                        i(n["c" + l + a], t, e, "c"),
                        i(n["secureC" + l + "ion" + a], t, e, "s"),
                        i(n["c" + l + u], t, e, "ce"),
                        i(n[d + a], t, e, "rq"),
                        i(n[p + a], t, e, "rp"),
                        i(n[p + u], t, e, "rpe"),
                        i(n.domLoading, t, e, "dl"),
                        i(n.domInteractive, t, e, "di"),
                        i(n[v + a], t, e, "ds"),
                        i(n[v + u], t, e, "de"),
                        i(n.domComplete, t, e, "dc"),
                        i(n[m + a], t, e, "l"),
                        i(n[m + u], t, e, "le"),
                        e
                    );
                ...
                function i() {
                    for (var n = document.cookie.split(" "), e = 0; e < n.length; e++)
                        if (0 === n[e].indexOf("NREUM=")) {
                            for (var t, r, o, i, u = n[e].substring("NREUM=".length).split("&"), s = 0; s < u.length; s++)
                                0 === u[s].indexOf("s=")
                                    ? (o = u[s].substring(2))
                                    : 0 === u[s].indexOf("p=")
                                    ? ((r = u[s].substring(2)), ";" === r.charAt(r.length - 1) && (r = r.substr(0, r.length - 1)))
                                    : 0 === u[s].indexOf("r=") && ((t = u[s].substring(2)), ";" === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)));
                            if (t) {
        ...
        21: [
            function (n, e, t) {
                function r(n, e) {
                    "undefined" == typeof e && (e = a.now() + a.offset), (u[n] = e);
                }
                function o(n, e, t) {
                    var r = u[e],
                        o = u[t];
            ...
            function (n, e, t) {
                function r() {
                    if (!E && null !== S) {
                        ...
                        e && (t.cls = e), s("lcp", Math.floor(n.startTime), t, !1), (E = !0);
                    }
                }
                function o(n) {
                    if (S) {
                ...
                function i(n) {
                    null === T && (T = 0), (T += n.value);
                }
                function a(n, e) {
                    N || "hidden" !== e || (s("pageHide", n, null, !0), (N = !0));
                }
                function u() {
                    s("unload", g.now(), null, !0);
                }
                function s(n, e, t, r) {
                    (t = t || {}), r && null !== T && (t.cls = T), j.push({ name: n, value: e, attrs: t });
                }
                function c(n, e, t) {
                    "fi" === n && setTimeout(r, 0), s(n, e, t, !0);
                }
                function f(n) {
                    if (0 !== j.length) {
                        var e = d(j);
                        y.send("events", g, { body: { e: e } }, { unload: !!n }), (j = []);
                    }
                }
                function l() {
                    r(), u(), f(!0);
                ...
                function d(n) {
                    for (var e = v(), t = "bel.6;", r = 0; r < n.length; r++) {
                        var o = n[r];
                        (t += "e,"), (t += e(o.name) + ","), (t += p(o.value, m, !1) + ",");
                        var i = h(o.attrs, e);
                ...
                var p = n(4).nullable,
                    m = n(4).numeric,
                    v = n(4).getAddStringContext,
                    h = n(4).addCustomAttributes;
                if (((e.exports = { getPayload: d }), !("init" in NREUM && "page_view_timing" in NREUM.init && "enabled" in NREUM.init.page_view_timing && NREUM.init.page_view_timing.enabled === !1))) {
                    var g = n("loader"),
                        y = n(9),
                        b = n(17),
                        w = n(12),
        ...
        27: [
            function (n, e, t) {
                ...
                function o(n) {
                    ...
                    return e.frames.length ? { mode: "stack", name: n.name || c(n), message: n.message, stackString: m(e.stackLines), frames: e.frames } : null;
                }
                function i(n, e) {
                    var t = a(e);
                ...
                function a(n) {
                    ...
                    return (
                        e || (e = n.match(y)),
                        e
                            ? { url: e[2], func: ("Anonymous function" !== e[1] && "global code" !== e[1] && e[1]) || null, line: +e[3], column: e[4] ? +e[4] : null }
                ...
                function u(n) {
                    ...
                    var e = n.name || c(n);
                    if (!n.sourceURL) return { mode: "sourceline", name: e, message: n.message, stackString: c(n) + ": " + n.message + "\n    in evaluated code", frames: [{ func: "evaluated code" }] };
                    var t = e + ": " + n.message + "\n    at " + n.sourceURL;
                    return n.line && ((t += ":" + n.line), n.column && (t += ":" + n.column)), { mode: "sourceline", name: e, message: n.message, stackString: t, frames: [{ url: n.sourceURL, line: n.line, column: n.column }] };
                }
                function s(n) {
                    var e = n.name || c(n);
                    return e ? { mode: "nameonly", name: e, message: n.message, stackString: e + ": " + n.message, frames: [] } : null;
                }
                function c(n) {
                ...
                function l(n) {
                    ...
                    for (var e, t = n.stacktrace, r = / line (\d+), column (\d+) in (?:<anonymous function: ([^>]+)>|([^\)]+))\(.*\) in (.*):\s*$/i, o = t.split("\n"), i = [], a = [], u = !1, s = 0, l = o.length; s < l; s += 2)
                        if ((e = r.exec(o[s]))) {
                            var d = { line: +e[1], column: +e[2], func: e[3] || e[4], url: e[5] };
                            f(d.func) ? (u = !0) : a.push(o[s]), u || i.push(d);
                        } else a.push(o[s]);
                    return i.length ? { mode: "stacktrace", name: n.name || c(n), message: n.message, stackString: m(a), frames: i } : null;
                }
                function d(n) {
                    ...
                    for (r = 2, o = e.length; r < o; r += 2) {
                        var g = null;
                        if ((t = i.exec(e[r]))) g = { url: t[2], func: t[3], line: +t[1] };
                    ...
                    return s.length ? { mode: "multiline", name: n.name || c(n), message: e[0], stackString: m(l), frames: s } : null;
                }
                var p = n(39),
                    m = n(28),
            ...
            function (n, e, t) {
                function r(n, e, t) {
                    ...
                    if (!(g.length >= h)) {
                        ...
                        var l = { timestamp: n + u.offset, timeSinceLoad: n / 1e3, browserWidth: o, browserHeight: a, referrerUrl: i, currentUrl: d("" + location), pageUrl: d(u.origin), eventType: "PageAction" };
                ...
                document.referrer && (i = d(document.referrer)),
                    f("api-setCustomAttribute", o, "api"),
                    a.on("feat-ins", function () {
                        f("api-addPageAction", r),
                            l.on("ins", function () {
                                var n = { qs: { ua: u.info.userAttributes, at: u.info.atts }, body: { ins: g } };
                                return (g = []), n;
                            }),
                            p(function () {
                                l.sendX("ins", u);
            ...
            function (n, e, t) {
                function r(n) {
                    var e,
                        ...
                        r,
                        o = Date.now();
                    for (e in n) (t = n[e]), "number" == typeof t && t > 0 && t < o && ((r = n[e] - w.offset), d({ n: e, s: r, e: r, o: "document", t: "timing" }));
                }
                function o(n, e, t, r) {
                    var o = "timer";
                ...
                function l(n, e, t, r) {
                    if ("xhr" === n) {
                        var o = { n: "Ajax", s: r.time, e: r.time + r.duration, o: t.status + " " + t.method + ": " + t.host + t.pathname, t: "ajax" };
                        d(o);
                    }
                }
                function d(n) {
                ...
                function m() {
                    ...
                    var n = E(
                        j(q, function (n, e) {
                            return n in M ? E(j(E(e.sort(v), h(n), {}), g), y, []) : e;
                        }),
                        y,
                        []
                    );
                    ...
                    q = {};
                    var e = { qs: { st: "" + w.offset, ptid: _ }, body: { res: n } };
                    if (!_) {
                ...
                if (k.xhrUsable && w.xhrWrappable) {
                    var _ = "",
                        R = { mouseup: !0, mousedown: !0 },
                        M = { typing: [1e3, 2e3], scrolling: [100, 1e3], mousing: [1e3, 2e3], touching: [1e3, 2e3] },
                        U = {
                        ...
                        q = {},
                        I = n("ee");
                    if (((e.exports = { _takeSTNs: m }), n(20), w.features.stn)) {
                        I.on("feat-stn", function () {
                            r(window.performance.timing), k.on("resources", p(m));
                            var n = k.sendX("resources", w, { needResponse: !0 });
                            n.addEventListener(
                                "load",
                                function () {
                                    _ = this.responseText;
            ...
            function (n, e, t) {
                ...
                e.exports = function (n) {
                    ...
                    !o.port && i[1] && (o.port = i[1].split("/")[0].split("@").pop().split(":")[1]),
                        ...
                        (o.hostname = e.hostname || t.hostname),
